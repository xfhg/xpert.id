<template>
  <div>
        ...
        <v-card class="elevation-0 mx-1 mb-5 pa-1" color="#fff">
          <v-row no-gutters>
            <v-col class cols="12" sm="12" md="12">
              <div class="text-overline ml-5">·: academy</div>
            </v-col>
          </v-row>
        </v-card>
        <v-divider></v-divider>
    ...
    <v-sheet class="" color="#f7fafc" min-height="25">
      <v-sheet class="mb-10" color="transparent" min-height="350px">
        <v-row no-gutters>
      ...
      <v-row no-gutters>
        ...
        <v-col class cols="12" sm="12" md="8" xl="4">
          <v-sheet
            ...
            color="transparent"
          >
            <div class="text-h3 mt-10" style="color: #f6f9fc"></div>
            <div class="text-overline ml-5" style="color: #f6f9fc"></div>
